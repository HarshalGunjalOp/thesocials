...
export function OurImpact() {
  return (
    <section className="w-screen flex justify-center items-center py-12 md:py-24 lg:py-32 bg-background">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="pt-[4rem] sm:tracking-wide text-xl max-w-[300px] sm:max-w-[600px] md:max-w-[700px] sm:text-3xl font-bold text-center mb-3">Our Impact</h2>
          </div>
        </div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                ref={ref}
                className="flex flex-col items-center justify-center space-y-2 border rounded-lg p-8 transition-all hover:border-primary"
              >
